<?php
	...
	/*
		* Random_UserAgent() gera uma string randomica com um useragent
		* @author Charles Corrêa <charlescorreaweb@gmail.com>
		* @version 0.1
		* @return = string
		* @copyright Copyright © 2019, Charles Corrêa - Soluções Web & SMS Marketing.
	*/
	
	
	function Random_UserAgent() {
      $browser_frequencia = array(
      ...
      foreach ($browser_frequencia as $k => $v) {
            $max += $v;
      }
